    ...
    return (
        <div className="product-shot">
            ...
            <button className="heart-button" onClick={(e) => wishListToggle(e)}>
                <svg className={searchWishList(cartState, product) === true ? "heart-red" : ""} width="1em" height="1em" viewBox="0 0 16 16"><g><path fillRule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15C-7.534 4.736 3.562-3.248 8 1.314z"></path></g></svg>
            </button>

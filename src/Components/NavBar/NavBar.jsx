            ...
            <div className="right-nav-links">
                <div>
                    <svg
                        ...
                        className={route === "Wishlist" ? "active" : ""}

    ...
    return (
        <nav className="nav-bar">
            <div className="left-nav">
                {showMenu ?
                    <svg onClick = {() => setShowMenu(false)} width="1em" height="1em" viewBox="0 0 512 512"><path d="M289.94 256l95-95A24 24 0 0 0 351 127l-95 95l-95-95a24 24 0 0 0-34 34l95 95l-95 95a24 24 0 1 0 34 34l95-95l95 95a24 24 0 0 0 34-34z" fill="currentColor"></path></svg>
                    :
                    <svg onClick={() => setShowMenu(true)} width="1em" height="1em" viewBox="0 0 512 512">
                ...
                <div>
                    ...
                    <Link to="/wishlist">
                        <span className="badge">
                            ...
                            {cartState.wishList && cartState.wishList.length !== 0 && <div className="number">{cartState.wishList.length}</div>}
                        </span>
                    </Link>                       
                    ...
                    <Link to="/cart">
                        ...
                        <svg width="1em" height="1em" viewBox="0 0 256 256"><path d="M216 64h-40.68a47.99 47.99 0 0 0-94.64 0H40a16.018 16.018 0 0 0-16 16v128a16.018 16.018 0 0 0 16 16h176a16.018 16.018 0 0 0 16-16V80a16.018 16.018 0 0 0-16-16zm-88-24a32.058 32.058 0 0 1 30.987 24H97.013A32.058 32.058 0 0 1 128 40zm88 168H40V80h40v24a8 8 0 0 0 16 0V80h64v24a8 8 0 0 0 16 0V80h40z" fill="currentColor"></path></svg>
                            {cartState.cart && cartState.cart.length !== 0 &&<div className="number">{cartState.cart.length}</div>}
                        </span>
                    </Link>

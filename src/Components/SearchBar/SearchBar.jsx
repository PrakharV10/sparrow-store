        ...
        <div className={showSearch ? "search-bar-bg" : "search-bar-bg hide"}>
            <div className={showSearch ? "search-bar-modal" : "search-bar-modal hide"}>
                <div className="heading">
                    ...
                    <svg onClick={() => setShowSearch(false)} width="1em" height="1em" viewBox="0 0 512 512"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" d="M368 368L144 144"></path><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" d="M368 144L144 368"></path></svg>
                </div>
